...
def occupancy_normalized_histogram(sample_bin, time_thres, covariates, cov_bins, 
                                   activities=None, spiketimes=None):
    """
    ...
    occupancy_time[occupancy_time < time_thres] = 0.0  # take care of unvisited/uncounted bins
