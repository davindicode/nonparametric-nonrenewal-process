...
def main():
    ...
    nonconvex_trials = 2
    modes_tot = [('NB', 'pos_th_s_hd', None, 40), 
                 ('ZIP', 'pos_th_s_hd', None, 40), 
                 ('CMP', 'pos_th_s_hd', None, 40), 
                 ('NBh', 'pos_th_s_hd', None, 40), 
                 ('ZIPh', 'pos_th_s_hd', None, 40), 
                 ('CMPh', 'pos_th_s_hd', None, 40)]
    ...
    for m in modes:
        ...
        cv_set = neural_utils.SpikeTrainCV(folds, rc_t, resamples, rcov)
        for kcv in cv_runs:
            if kcv is not None:
            ...
            for kk in range(nonconvex_trials):
                ...
                while True:
                    try:
                        glm, _ = models.set_glm(r_mode, ll_mode, spk_cpl, fcov, units_used, tbin, ftrain, 
                ...
                if losses[-1] < lowest_loss:
                    ...
                    # save model
                    model_name = 'GPCR_{}_{}_{}_cv={}'.format(session_id, ll_mode, rr_mode, kcv)
