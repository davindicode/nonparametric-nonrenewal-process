...
python3 th1.py spikes --data_path ../../data/th1/ --session_name Mouse28_140313_wake --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -10 --batch_size 10000 --observed_covs hd --observations factorized_gp-8-1000 --likelihood PP-log --filter_type svgp-10-3.-10.-self-H500 --device 0
...
# BNPP
python3 th1.py spikes --data_path ../../data/th1/ --session_name Mouse28_140313_wake --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -10 --batch_size 10000 --observed_covs hd --observations nonparam_pp_gp-40-matern32-1000-12. --likelihood isi4 --freeze_params obs_model.log_refract_amp --device 0
