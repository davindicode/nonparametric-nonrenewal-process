...
python3 hc3.py spikes --data_path ../../data/hc3/ --session_name ec014.29_ec014.468_isi5 --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -100 --batch_size 10000 --observed_covs x-hd-theta --observations rate_renewal_gp-32-1000 --unroll 10 --filter_type rcb-16-17.-36.-6.-30.-self-H500 --freeze_params obs_model.spikefilter.a obs_model.spikefilter.log_c obs_model.spikefilter.phi --likelihood gamma-log --device 0


python3 th1.py spikes --data_path ../../data/th1/ --session_name Mouse28_140313_wake_isi5 --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -100 --batch_size 10000 --observed_covs hd-x-y-speed --observations rate_renewal_gp-32-1000 --unroll 10 --likelihood lognorm-log --filter_type rcb-16-17.-36.-6.-30.-self-H500 --freeze_params obs_model.spikefilter.a obs_model.spikefilter.log_c obs_model.spikefilter.phi --device 0
...
python3 hc3.py spikes --data_path ../../data/hc3/ --session_name ec014.29_ec014.468_isi5 --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -100 --batch_size 10000 --observed_covs x-speed-theta --observations factorized_gp-32-1000 --filter_type rcb-8-17.-36.-6.-30.-self-H500 --freeze_params obs_model.spikefilter.a obs_model.spikefilter.log_c obs_model.spikefilter.phi --likelihood PP-log --device 1
