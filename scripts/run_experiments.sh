...
python3 th1.py spikes --data_path ../../data/th1/ --session_name Mouse28_140313_wake_isi5 --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -10 --batch_size 10000 --observed_covs hd --observations rate_renewal_gp-8-1000 --unroll 10 --lik_int_method MC-1 --likelihood invgauss-log --device 0
...
python3 hc3.py spikes --data_path ../../data/hc3/ --session_name ec014.29_ec014.468_isi5 --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -10 --batch_size 30000 --observed_covs x-hd-theta --observations rate_renewal_gp-32-1000 --likelihood gamma-log --unroll 10 --lik_int_method MC-1 --jitter 1e-6 --device 0
...
python3 hc3.py spikes --data_path ../../data/hc3/ --session_name ec014.29_ec014.468_isi5 --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -10 --batch_size 30000 --observed_covs x-hd-theta --observations rate_renewal_gp-32-1000 --unroll 10 --filter_type rcb-8-10.-20.-4.5-9.-self-H150 --freeze_params obs_model.spikefilter.a obs_model.spikefilter.log_c obs_model.spikefilter.phi --likelihood gamma-log --lik_int_method MC-1 --jitter 1e-6 --device 1

python3 hc3.py spikes --data_path ../../data/hc3/ --session_name ec014.29_ec014.468_isi5 --select_frac 0.0 0.5 --seeds 1 2 3 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -10 --batch_size 30000 --observed_covs x-hd-theta --observations rate_renewal_gp-32-1000 --unroll 10 --filter_type rcb-8-10.-20.-4.5-9.-self-H150 --freeze_params obs_model.spikefilter.a obs_model.spikefilter.log_c obs_model.spikefilter.phi --likelihood invgauss-log --lik_int_method MC-1 --jitter 1e-6 --device 1

python3 hc3.py spikes --data_path ../../data/hc3/ --session_name ec014.29_ec014.468_isi5 --select_frac 0.0 0.5 --seeds 123 2 23 --lr_start 1e-2 --lr_decay 0.98 --lr_end 1e-4 --margin_epochs 100 --loss_margin -10 --batch_size 10000 --observed_covs x-hd-theta --observations factorized_gp-40-1000 --filter_type svgp-6-n2.-10.-self-H150 --likelihood PP-log --jitter 1e-5 --device 1
