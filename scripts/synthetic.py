...
def get_dataset(datatype):
    ...
    return cov_tuple, units_used, tbin, resamples, spktrain, max_count, bin_size, metainfo, model_name
...
def enc_used_(datatype, map_mode, ll_mode, x_mode, z_mode, cov_tuple, in_dims, inner_dims, jitter, tensor_type):
    """
    """
    ...
    def kernel_used_(datatype, x_mode, z_mode, cov_tuple, num_induc, out_dims, var, tensor_type):
        """
    ...
    if map_mode[:4] == 'svgp':
        ...
        kernelobj, inducing_points = kernel_used_(datatype, x_mode, z_mode, cov_tuple, num_induc, 
        ...
        ffnn = nppl.mappings.FFNN(input_dim, out_dims, mu_ANN, sigma_ANN=None, tensor_type=torch.float, active_dims=None)
